...
export TF_VAR_project=cloudlamp-org
...
#NFS server
export TF_VAR_nfs_snapshot="empty-snapshot"     #a pre-created empty ext4 snapshot
...
#cloudSQL
export TF_VAR_cloudsql_instance="groundcontrol-sql2"
...
#GKE cluster details
export TF_VAR_gke_cluster_name="cloudlamp-gke"
